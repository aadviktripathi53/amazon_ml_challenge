"""Stage 1: normalise raw records -> data/interim/records.parquet.

STUB (owner: B). Run as ``python -m src.normalize --split <train|val|test>``
...
def main(argv: Optional[Sequence[str]] = None) -> None:
    ...
    raise NotImplementedError(f"stage 'normalize' is a stub (split={split})")
