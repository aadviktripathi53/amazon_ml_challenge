"""Stage 4: train the pair model (train/val) or predict (test) -> data/interim/preds_{split}.parquet.

STUB (owner: C). Run as ``python -m src.train --split <train|val|test>``
...
def main(argv: Optional[Sequence[str]] = None) -> None:
    ...
    raise NotImplementedError(f"stage 'train' is a stub (split={split})")
