"""Stage 3: pair features -> data/interim/features_{split}.parquet.

STUB (owner: C). Run as ``python -m src.features --split <train|val|test>``
...
def main(argv: Optional[Sequence[str]] = None) -> None:
    ...
    raise NotImplementedError(f"stage 'features' is a stub (split={split})")
